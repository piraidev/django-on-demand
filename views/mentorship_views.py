...
class MentorshipViewSet(viewsets.ModelViewSet):
    ...
    def update(self, request, *args, **kwargs):
        ...
        if(mentorship_status == 'cancelled'):
            ...
            email_service.send_email(user.email, settings.SENGRID_REQUEST_CANCELLED_TEMPLATE_ID, {'to_name': user.first_name, 'from_name': from_user.first_name})
            ...
            email_service.send_email(user.email, settings.SENGRID_REQUEST_FINISHED_MENTOR_TEMPLATE_ID, {'to_name': user.first_name, 'from_name': from_user.first_name, 'mentor_ranking': ranking})
            email_service.send_email(from_user.email, settings.SENGRID_REQUEST_FINISHED_MENTEE_TEMPLATE_ID, {'to_name': from_user.first_name, 'from_name': user.first_name})
            ...
            email_service.send_email(user.email, settings.SENGRID_REQUEST_ACCEPTED_TEMPLATE_ID, {'to_name': user.first_name, 'from_name': from_user.first_name})
            ...
            email_service.send_email(user.email, settings.SENGRID_REQUEST_REJECTED_TEMPLATE_ID, {'to_name': user.first_name, 'from_name': from_user.first_name, 'rejection_reason': rejection_reason})
